...
<title>Brite | Multipurpose HTML5 Template</title>
    ...
    <div class="col-md-12 nopadding">
      <div class="header-section white style1 white pin-style">
        <div class="container">
          <div class="mod-menu">
            <div class="row">
              <div class="col-sm-2"> <a href="index.html" title="" class="logo mar-4"> <img src="images/logo/logo-dark.png" alt=""> </a> </div>
              <div class="col-sm-10">
                <div class="main-nav">
                    ...
                    <ul class="nav navbar-nav">
                      ...
                      <li class="active"> <a href="slider-kenburns.html">Pages</a> <span class="arrow"></span>
                        <ul class="dm-align-2">
                          ...
                          <li class="active"> <a href="#">Contact<span class="sub-arrow dark pull-right"><i class="fa fa-angle-right" aria-hidden="true"></i></span> </a> <span class="arrow"></span>
                            <ul>
...
<div class="col-md-3 col-sm-12 colmargin clearfix margin-bottom">
        ...
        <ul class="footer-social-icons primary left-align icons-plain text-center">
                  ...
                  <li><a class="active" href="https://www.facebook.com/codelayers"><i class="fa fa-facebook"></i></a></li>
          ...
          <!--end item-->
            ...
            <div class="item-holder">
              ...
              <div class="clearfix"></div>
              <div class="fo-posts">
                <div class="imgbox-medium left"><img src="http://via.placeholder.com/300x300" alt="" class="img-responsive"/></div>
